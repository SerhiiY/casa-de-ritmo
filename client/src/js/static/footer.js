...
<footer>
  <nav class="networks">
    ...
    <a href="https://www.facebook.com/CasaDeRitmo/">
      <svg className="facebook-icon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          width="32px" height="32px" fill="#4267B2" viewBox="0 0 60.734 60.733" style={{ enableBackground: "new 0 0 60.734 60.733" }} xmlSpace="preserve">
    ...
    <a href="https://www.youtube.com/channel/UCsZjPEyhx-mtgmRn4BjXyGw"><img src="./img/footer/youtube.svg" style={{ width: "32px", height: "32px" }} alt="YouTube"/></a>
